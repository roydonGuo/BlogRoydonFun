...
<img src="/images/posts/agent-subagent-delegation-engineering-knowledge-map.webp" alt="AI Agent 的 SubAgent 工程实践：任务委派、上下文隔离与结果回收知识串联图" style="border-radius: 10px;" />
