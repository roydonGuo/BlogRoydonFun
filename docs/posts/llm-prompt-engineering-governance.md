...
tags: [llm, prompt-engineering, spring-ai]
...
<img src="/images/posts/llm-prompt-engineering-governance-knowledge-map.webp" alt="LLM Prompt 工程实践：指令分层、模板治理与注入防护知识串联图" style="border-radius: 10px;" />
