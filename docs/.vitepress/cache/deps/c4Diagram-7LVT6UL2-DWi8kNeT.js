...
import { H as setAccDescription, U as setAccTitle, c as configureSvgSize, r as assignWithDepth_default, s as common_default, v as getAccDescription, x as getConfig2, y as getAccTitle, z as sanitizeText } from "./chunk-DU6HZSFF-DTl6_G91.js";
import { _ as wrapLabel, n as calculateTextHeight, r as calculateTextWidth } from "./chunk-75Z2AOVW-DbtQOCJ4.js";
...
import { a as drawRect } from "./chunk-F27PBJKO-Bg5d0ftk.js";
...
var getIntersectPoint = /* @__PURE__ */ __name(function(fromNode, endPoint) {
	if (!fromNode.intersect) throw new Error(`C4 shape "${fromNode.alias}" has no intersect function. Please report this to https://github.com/mermaid-js/mermaid/issues`);
...
var drawRels2 = /* @__PURE__ */ __name(function(diagram2, rels2, getC4ShapeObj, diagObj, diagramId) {
	...
	for (const rel of rels2) {
		...
		if (!fromNode || !endNode) throw new Error(`C4 rel "${rel.from}" -> "${rel.to}" references an unknown shape`);
