...
import { A as hasKatex, B as sanitizeText3, M as parseGenericTypes, T as getEffectiveHtmlLabels, b as getConfig, f as defaultConfig_default, g as evaluate, x as getConfig2, z as sanitizeText } from "./chunk-DU6HZSFF-DTl6_G91.js";
import { a as decodeEntities, p as parseFontSize, r as calculateTextWidth, u as handleUndefinedAttr } from "./chunk-75Z2AOVW-DbtQOCJ4.js";
import { a as userNodeOverrides, i as styles2String, r as solidStateFill, t as compileStyles } from "./chunk-P2QGCYS3-DukUiT-K.js";
import { t as getIconSVG } from "./chunk-PWAF6VOD-Chi-gHl7.js";
import { n as createText, r as fastdom_default } from "./chunk-GMAD6QVW-CCJrP0kd.js";
...
var labelHelper = /* @__PURE__ */ __name(async (parent, node, _classes) => {
	...
	} else bbox = await fastdom_default.measure(() => text2.getBBox());
...
async function collapsedGroup(parent, node) {
	...
	if (node.look === "handDrawn") {
		...
		const roughNode = rc.path(createRoundedRectPathD(x, y, totalWidth, totalHeight, RADIUS), roughOpts);
