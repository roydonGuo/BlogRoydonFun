//#region node_modules/.pnpm/@giscus+vue@3.1.1_vue@3.5.42/node_modules/@giscus/vue/dist/giscus-Ci9LqPcC.js
/**
* @license
...
var $t = (i, ...t) => {
	return new ht(i.length === 1 ? i[0] : t.reduce((s, r, o) => s + ((n) => {
...
* SPDX-License-Identifier: BSD-3-Clause
*/
var { is: gt, defineProperty: ft, getOwnPropertyDescriptor: mt, getOwnPropertyNames: At, getOwnPropertySymbols: yt, getPrototypeOf: St } = Object, A = globalThis, Q = A.trustedTypes, vt = Q ? Q.emptyScript : "", Y = A.reactiveElementPolyfillSupport, U = (i, t) => i, L = {
	toAttribute(i, t) {
		switch (t) {
			case Boolean:
				i = i ? vt : null;
				break;
			case Object:
			case Array: i = i == null ? i : JSON.stringify(i);
		}
		return i;
	},
	fromAttribute(i, t) {
...
E.elementStyles = [], E.shadowRootOptions = { mode: "open" }, E[U("elementProperties")] = /* @__PURE__ */ new Map(), E[U("finalized")] = /* @__PURE__ */ new Map(), Y?.({ ReactiveElement: E }), (A.reactiveElementVersions ?? (A.reactiveElementVersions = [])).push("2.0.4");
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
var I = class I {
	...
	_$AR(t = this._$AA.nextSibling, e) {
		var s;
		for ((s = this._$AP) == null || s.call(this, !1, !0, e); t && t !== this._$AB;) {
...
var z = class {
	...
	constructor(t, e, s, r, o) {
		this.type = 1, this._$AH = l, this._$AN = void 0, this.element = t, this.name = e, this._$AM = r, this.options = o, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(/* @__PURE__ */ new String()), this.strings = s) : this._$AH = l;
	}
	_$AI(t, e = this, s, r) {
...
j?.(R, I), (P.litHtmlVersions ?? (P.litHtmlVersions = [])).push("3.2.1");
var Rt = (i, t, e) => {
...
var p = class extends O {
	...
	getTerm() {
		switch (this.mapping) {
			case "url": return this._getCleanedUrl().toString();
			case "title": return document.title;
			case "og:title": return this.getMetaContent("title", !0);
			case "specific": return this.term ?? "";
			case "number": return "";
			default: return location.pathname.length < 2 ? "index" : location.pathname.substring(1).replace(/\.\w+$/, "");
		}
	}
	getNumber() {
	...
	getIframeSrc() {
		...
		return `${this._host}${this.lang ? `/${this.lang}` : ""}/widget?${new URLSearchParams(r).toString()}`;
	}
	render() {
		return wt`
      <iframe
...
p.styles = $t`
  ...
  `;
$([_({ reflect: !0 })], p.prototype, "host", 2);
$([_({ reflect: !0 })], p.prototype, "repo", 2);
$([_({ reflect: !0 })], p.prototype, "repoId", 2);
$([_({ reflect: !0 })], p.prototype, "category", 2);
$([_({ reflect: !0 })], p.prototype, "categoryId", 2);
$([_({ reflect: !0 })], p.prototype, "mapping", 2);
$([_({ reflect: !0 })], p.prototype, "term", 2);
$([_({ reflect: !0 })], p.prototype, "strict", 2);
$([_({ reflect: !0 })], p.prototype, "reactionsEnabled", 2);
$([_({ reflect: !0 })], p.prototype, "emitMetadata", 2);
$([_({ reflect: !0 })], p.prototype, "inputPosition", 2);
$([_({ reflect: !0 })], p.prototype, "theme", 2);
$([_({ reflect: !0 })], p.prototype, "lang", 2);
$([_({ reflect: !0 })], p.prototype, "loading", 2);
p = $([Jt("giscus-widget")], p);
//#endregion
