...
import { A as hasKatex, F as renderKatexSanitized, b as getConfig, s as common_default, z as sanitizeText } from "./chunk-DU6HZSFF-DTl6_G91.js";
import { a as decodeEntities } from "./chunk-75Z2AOVW-DbtQOCJ4.js";
import { n as isIconAvailable, t as getIconSVG } from "./chunk-PWAF6VOD-Chi-gHl7.js";
...
var require_fastdom = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(win) {
		...
		*/
		...
		var exports$2 = win.fastdom = win.fastdom || new FastDom();
		if (typeof define == "function") define(function() {
			return exports$2;
		});
		else if (typeof module == "object") module.exports = exports$2;
...
var require_fastdom_promised = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function() {
		...
		*/
		...
		else if ((typeof module)[0] == "o") module.exports = exports$1;
		else window.fastdomPromised = exports$1;
	})();
}));
//#endregion
//#region node_modules/.pnpm/marked@16.4.2/node_modules/marked/lib/marked.esm.js
var import_fastdom = /* @__PURE__ */ __toESM(require_fastdom(), 1);
var import_fastdom_promised = /* @__PURE__ */ __toESM(require_fastdom_promised(), 1);
/**
...
var fastdom_default = import_fastdom.default.extend({ 
/**
...
async function addHtmlSpan(element, node, width, classes, addBackground = false, config = getConfig()) {
	...
	if ((await fastdom_default.measure(() => div.node().getBoundingClientRect())).width === width) {
