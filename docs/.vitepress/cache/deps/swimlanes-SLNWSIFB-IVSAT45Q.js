import {
  clear as clear4
} from "./chunk-PAASJLOY.js";
import {
  Graph
} from "./chunk-3Z2QIHGK.js";
import {
  clear as clear3,
  edgeLabels,
  insertEdge,
...
import {
  ...
  insertNode,
  positionNode
} from "./chunk-OBXWRMKL.js";
import "./chunk-ZT3UL76K.js";
import "./chunk-F3YNJB4R.js";
import {
  markerOffsets
} from "./chunk-ZQ6NIX4G.js";
import {
  getSubGraphTitleMargins
} from "./chunk-J23WS7UO.js";
import "./chunk-ZEU6VWC7.js";
import "./chunk-C27KMCQY.js";
import {
  utils_default
...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await import("./sizeCapture-X5ZJPWSS-EC3V6YPD.js");
...
function assignCoordinates(ordered, gWithDummies, opts) {
  ...
  const getWidth = __name((id) => getNode(id)?.width ?? 0, "getWidth");
  const getHeight = __name((id) => getNode(id)?.height ?? 0, "getHeight");
  const topLaneOf = createTopLaneResolver(gWithDummies);
...
function routeEdgesOrthogonal(data, direction) {
  ...
  const edgeHasLabelNode = __name((edgeIdx) => Boolean(edges[edgeIdx]?.labelNodeId), "edgeHasLabelNode");
...
//# sourceMappingURL=swimlanes-SLNWSIFB-IVSAT45Q.js.map
