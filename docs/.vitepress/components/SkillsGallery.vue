<template>
  <div
      class="skills-shell fixed inset-x-0 bottom-0 top-[var(--vp-nav-height)] z-20 grid grid-cols-[340px_1fr] overflow-hidden border-y border-divider bg-bg text-text-1 max-[760px]:block max-[760px]:overflow-y-auto">
    <aside
