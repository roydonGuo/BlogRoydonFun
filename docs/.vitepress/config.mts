...
export default defineConfig({
    ...
    themeConfig: {
        ...
        socialLinks: [
            ...
            // 顶部导航提供显式 RSS 订阅入口。
            {
                icon: {svg: '<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M6.18 17.82a2.18 2.18 0 1 1-4.36 0 2.18 2.18 0 0 1 4.36 0ZM1.82 8.55v3.1A10.53 10.53 0 0 1 12.35 22.18h3.1A13.63 13.63 0 0 0 1.82 8.55Zm0-6.73v3.1A17.26 17.26 0 0 1 19.08 22.18h3.1A20.36 20.36 0 0 0 1.82 1.82Z"/></svg>'},
                link: '/feed.xml',
                ariaLabel: 'RSS Feed'
            },
        ],
